...
- presidiare eventi rilevanti e curarne restituzione/divulgazione all'interno della fondazione
...
+ **Dare visibilità al lavoro dell'Osservatorio** — con `output modulari` (blog, rubriche, mini-analisi), affiancati ad alcuni `studi di ampio respiro` a cadenza più lunga

+ **Profondità vs ampiezza** — discernere temi strategicamente rilevanti per cui valga la pena pianificare ricerche approfondite (anche con `raccolta di dati sperimentali` _ad hoc_)
  - e.g. indagine sul trasporto sociale 

+ **In-house vs commissionato** — criteri per distinguere le analisi da tenere `in house` (dove abbiamo ==vantaggio== competitivo, e.g. il rapporto diretto con gli Enti) da quelle da commissionare a terzi
